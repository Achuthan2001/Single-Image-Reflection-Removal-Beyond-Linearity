...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--loadSizeH', type=int, default=768, help='scale images to this height')
        self.parser.add_argument('--loadSizeW', type=int, default=1024, help='scale images to this width')
